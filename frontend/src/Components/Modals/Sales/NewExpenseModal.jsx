...
const NewExpenseModal = () => {
    return ( 
        <div className={`modal fade`} id="newExpense" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden={true}>
            <div className="modal-dialog ">
                <div className="modal-content" style={{background: 'rgba(255,255,255,0.55)', backdropFilter: 'blur(4px)', border: '1px solid rgba(255,255,255,0.175)'}}>
                    <div className="modal-header">
                        <div>
                            <h1 className="modal-title fs-6" id="staticBackdropLabel">Create New Expense</h1>
                        </div>
